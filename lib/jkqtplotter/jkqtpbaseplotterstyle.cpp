...
JKQTBasePlotterStyle::JKQTBasePlotterStyle():
    ...
    // There is some code that handles this +XITS, but the problem is that this
    // is being passed to Qt directly somewhere and it is confused about the non-existent font
    //    plotLabelFontName(QApplication::font().family()+"+XITS"),
    plotLabelFontName(QApplication::font().family()),
    ...
    defaultFontName(QApplication::font().family()),
